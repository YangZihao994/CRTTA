...
parser.add_argument("--json-root", type=str, default='./READ/_code_clean/json_csv_files/vgg', help="validation data json")
parser.add_argument("--label-csv", type=str, default='./READ/_code_clean/json_csv_files/class_labels_indices_vgg.csv', help="csv with class labels")
